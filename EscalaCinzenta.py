...
imgcolorida = cv2.imread("pic.jpg", cv2.IMREAD_COLOR)# carrega "pic.jpg". IMREAD_GRAYSCALE é autoexplicativo
imgcinzenta= cv2.imread("pic.jpg", cv2.IMREAD_GRAYSCALE)# carrega "pic.jpg". IMREAD_GRAYSCALE é autoexplicativo
